...
if (averageDolphins > averageKoalas && averageDolphins > 100) {
  console.log(`Dolphin's win ${averageDolphins} to ${averageKoalas}`);
}
else if (averageKoalas > averageDolphins && averageKoalas > 100) {
  console.log(`Koala's win ${averageKoalas} to ${averageDolphins}`);
}
else if (averageDolphins > 100 && averageDolphins === averageKoalas) {
  console.log(`The teams had a draw with a score of ${averageKoalas}`)
}
else {
...
//Statements is a bigger piece of code that is executed and does not produce a value on its own
//Statements may include expression
//Statements are like sentances that perform actions
...
console.log(`The bill amount was ${billValue}, the tip amount should be ${tip} resulting in a total cost of ${billValue + tip}`);