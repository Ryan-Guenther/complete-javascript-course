...
const formatCur = function (amount, locale, currency) {
  ...
  return new Intl.NumberFormat(locale, options).format(amount.toFixed(2));
};
...
const options = {
  // for currency set style to currency and have to define the currency
  style: 'currency',
  currency: 'EUR',
  // Percent ignores the other units
  // style: 'percent',
  // style: 'unit',
  // unit: 'mile-per-hour',
  unit: 'celsius',
